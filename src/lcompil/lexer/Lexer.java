...
public class Lexer
{
    ...
    Token new1(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TOr(line, pos); }
    ...
    Token new8(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TInferior(line, pos); }
    Token new9(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TNo(line, pos); }
    ...
    Token new12(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TLCrochet(line, pos); }
    Token new13(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TRCrochet(line, pos); }
    Token new14(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TLAccolade(line, pos); }
    Token new15(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TRAccolade(line, pos); }
    ...
    Token new24(@SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TWrite(line, pos); }
    ...
    Token new29(@SuppressWarnings("hiding") String text, @SuppressWarnings("hiding") int line, @SuppressWarnings("hiding") int pos) { return new TIdentificator(text, line, pos); }
...
/*  {
        // INITIAL
        {-1, 25, 25, 25, 9, -1, 29, 2, 10, 11, 5, 3, 27, 4, 6, 0, 28, 8, 7, 12, 13, 29, 29, 29, 29, 29, 29, 29, 14, 1, 15, -1, 26, 26, 29, 29, 29, 29, 29, 29, 29, 16, 29, 26, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 23, 29, 29, 29, 17, 29, 29, 20, 29, 18, 29, 24, 21, 22, 29, 19, },
