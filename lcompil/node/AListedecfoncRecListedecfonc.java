...
public final class AListedecfoncRecListedecfonc extends PListedecfonc
{
    private PDecfonc _decfonc_;
    private PListedecfonc _listedecfonc_;

    public AListedecfoncRecListedecfonc()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new AListedecfoncRecListedecfonc(
    ...
    {
        ((Analysis) sw).caseAListedecfoncRecListedecfonc(this);
    }
