...
public final class ADecVaretfctProgram extends PProgram
{
    private POptdecvar _optdecvar_;
    private PListedecfonc _listedecfonc_;

    public ADecVaretfctProgram()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADecVaretfctProgram(
    ...
    {
        ((Analysis) sw).caseADecVaretfctProgram(this);
    }
